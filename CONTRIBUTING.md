...
質問・プルリクエスト、どれも歓迎します。このドキュメントは、貢献する前に
...
質問も [Issues](https://github.com/rami2076/moost/issues) で受け付けています
（メールや DM ではなく Issue に集約しています。同じ疑問を持つ人が後から
検索して見つけられるようにするためです）。「質問」テンプレートを選んで
新規作成してください。

まず README や既存の Issue（クローズ済みも含む）に同じ内容がないか検索してから、
なければ新規に立ててもらえると助かります。
